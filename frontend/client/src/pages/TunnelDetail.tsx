...
const TunnelDetail: React.FC = () => {
  ...
  useEffect(() => {
    const tunnelData = getTunnel(id);
    setTunnel(tunnelData);

    if (tunnelData) {
      setTunnelName(tunnelData.name);
  ...
  const handleCloseRequest = useCallback(async () => {
    ...
    try {
      ...
      // Success message
      alert(
        `Your request to close ${tunnel.name} has been submitted and will be reviewed by the Traffic Department.`
      );
  ...
  return !tunnel ? (
    ...
    <>
      <div
        className="tunnel-header mb-5 rounded-4 p-4 position-relative overflow-hidden"
        style={{
      ...
      >
        ...
        <div className="row align-items-center position-relative z-index-1">
          <div className="col-lg-8">
            {isEditing ? (
              <div className="d-flex gap-2 align-items-center w-100">
                ...
                />
                <button className="btn btn-success px-4" onClick={saveName}>
                  Save
                </button>
                <button
          ...
          <div className="col-lg-4 text-lg-end mt-4 mt-lg-0">
            <div
              className={`risk-level-indicator rounded-pill px-4 py-3 d-inline-flex align-items-center ${getRiskLevelBadgeClass(
                tunnel.riskLevel
              )}`}
            >
              <FaExclamationTriangle className="me-2" size={20} />
              <span className="fw-semibold fs-5">
                {tunnel.riskLevel} Risk Level
              </span>
            </div>
            <div className="mt-3">
              {hasPermission(["admin", "ministry", "traffic"]) ? (
                ...
                <div
                  className={`barrier-status-indicator px-4 py-2 rounded-pill d-inline-flex align-items-center ${
                    tunnel.barrierStatus === "Open"
      ...
      <div className="row g-4">
          ...
          <div className="card border-0 rounded-4 shadow-sm overflow-hidden mb-4">
            ...
            <div className="card-body p-4">
                ...
                <div className="col-md-6">
                  <div className="tunnel-detail-card border rounded-4 p-3 h-100 d-flex align-items-center">
                    ...
                    <div>
                      ...
                      <p className="fs-5 fw-bold mb-0">
                        {new Date(tunnel.lastUpdate).toLocaleString()}
                      </p>
                    </div>
                  </div>
                </div>
                <div className="col-md-6">
                  <div className="tunnel-detail-card border rounded-4 p-3 h-100 d-flex align-items-center">
                    ...
                    <div>
                      ...
                      <p className="fs-5 fw-bold mb-0">
                        {tunnel.sensors
                          ? Object.keys(tunnel.sensors).length
                          : 0}
                      </p>
                    </div>
                  </div>
              ...
              <div className="tunnel-map-container rounded-4 overflow-hidden mb-4">
                {tunnel.mapEmbedHtml ? (
                  <div
                    dangerouslySetInnerHTML={{ __html: tunnel.mapEmbedHtml }}
                  />
                ) : (
                  <div className="alert alert-secondary p-4 text-center">
                    ...
                    <p className="mb-0">
                      Map location for this tunnel has not been provided.
                    </p>
                  </div>
                )}
              </div>
        ...
        <div className="col-lg-4 d-flex flex-column gap-4">
                ...
                <>
                  <div className="mb-4">
                    ...
                    >
                      <div
                        ...
                        style={{
                          width: `${
                            ((sensorData.temperature ?? 0) / 50) * 100
                          }%`,
                        }}
                      ></div>
                    </div>
                  ...
                  <div className="mb-4">
                    <div className="d-flex justify-content-between align-items-center mb-2">
                      ...
                      <span className="fw-bold fs-5">
                        ...
                        <small>
                          ({sensorData.rainfallDuration ?? "00:00:00"})
                        </small>
                      </span>
                    </div>
                    <div
                    ...
                    >
                      <div
                        ...
                        style={{
                          width: `${((sensorData.rainfall ?? 0) / 20) * 100}%`,
                        }}
                      ></div>
                    </div>
                  </div>
                  ...
                  <div className="mb-4">
                    <div className="d-flex justify-content-between align-items-center mb-2">
                      ...
                      <span className="fw-bold fs-5">
                        {sensorData.rainfallIntensity ?? 0} mm/hr
                      </span>
                    </div>
                    <div
                      className="progress rounded-pill"
                    ...
                    >
                      <div
                        ...
                        style={{
                          width: `${
                            ((sensorData.rainfallIntensity ?? 0) / 50) * 100
                          }%`,
                        }}
                      ></div>
                    </div>
                  ...
                  <div className="mb-0">
                    <div className="d-flex justify-content-between align-items-center mb-2">
                      ...
                      <span
                        className={`fw-bold fs-5 ${
                          (sensorData.waterLevel ?? 0) > 750
                            ? "text-danger"
                            : (sensorData.waterLevel ?? 0) > 400
                            ? "text-warning"
                            : "text-success"
                        }`}
                      >
                        {sensorData.waterLevel ?? 0} mm
                      </span>
                    </div>
                    <div
                      className="progress rounded-pill"
                    ...
                    >
                      <div
                        ...
                        style={{
                          width: `${Math.min(
                            ((sensorData.waterLevel ?? 0) / 1500) * 100,
                            100
                          )}%`,
                        }}
                      ></div>
          ...
          <div className="card border-0 rounded-4 shadow-sm overflow-hidden">
            ...
            <div className="card-body p-4">
              <p className="mb-4">
                If you observe dangerous conditions in this tunnel, you can
                request an immediate closure. Your request will be reviewed by
      ...
      >
        ...
        <Modal.Body>
          <p>
            Are you sure you want to delete <strong>{tunnel.name}</strong>?
          </p>
      ...
      {/* Close Request Modal */}
      <Modal
        show={showCloseRequestModal}
        onHide={handleCloseRequestModalClose}
        centered
      >
        <Modal.Header closeButton>
          <Modal.Title className="text-danger">
        ...
        <Modal.Body>
          <p>
            You are requesting the closure of <strong>{tunnel.name}</strong> due
            to safety concerns.
          </p>
